...
namespace DInTaskSchedulerApi.Tools
{
    ...
    public static class ModelFormatter
    {
        ...
        /// <summary>
        /// Format RequestType model to CatalogViewModel
        /// </summary>
        public static CatalogViewModel FormatRequestTypeCatalogModel(RequestType model)
        {
            return new CatalogViewModel()
            {
                Id = model.Id,
        ...
        /// <summary>
        /// Format PropertyType model to CatalogViewModel
        /// </summary>
        public static CatalogViewModel FormatPropertyTypeCatalogModel(PropertyType model)
        {
            return new CatalogViewModel()
            {
                Id = model.Id,
